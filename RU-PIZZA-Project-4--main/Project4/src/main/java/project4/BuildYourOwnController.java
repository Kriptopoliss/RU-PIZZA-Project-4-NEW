...
public class BuildYourOwnController {
    ...
    // Handles the "Add Topping" button click.
    @FXML
    ...
    // Handles the "Remove Topping" button click.
    @FXML
    ...
    // Retrieves the selected sauce (Tomato or Alfredo).
    ...
    // Calculates and updates the price of the pizza based on user selections.
    ...
    // Finalizes the current order and creates a new one.
    @FXML
    ...
    // Checks if the pizza configuration is valid.
    ...
    // Loads a new scene using the provided FXML file path.
